                    ...
                    <div className="flex h-16 justify-between">
                        <div className="flex">
                            <div className="flex shrink-0 items-center">
                                <Link href="/">
                                    <img src="/img/logo-novafresh.png" alt="Novafresh" className="block h-9 w-auto" />
                                </Link>
                            </div>
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                {user.roles && user.roles.includes('super-admin') && (
                                    <NavLink
                                        href={route('admin.tipos_denuncia.index')}
                                        active={route().current('admin.tipos_denuncia.index')}
                                    >
